    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black transition-colors duration-300">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
        ...
        <div className="isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-x-8 xl:gap-x-12">
          ...
          {/* FREE TIER */}
          <div className="rounded-3xl p-8 ring-1 ring-zinc-200 dark:ring-zinc-800 bg-white dark:bg-zinc-900/50 backdrop-blur-xl">
          ...
          {/* PRO TIER */}
          <div className="relative rounded-3xl p-8 ring-1 ring-indigo-600 bg-zinc-900 dark:bg-black shadow-2xl">
