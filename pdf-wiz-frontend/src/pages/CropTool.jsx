...
import { Upload, Crop, Download, AlertCircle, Layers, FileText, ChevronLeft, ChevronRight, Lock, Sparkles, UploadCloud, X, Loader2 } from 'lucide-react';
...
export default function CropTool() {
    ...
    const loadDocument = async () => {
        ...
        try {
            ...
            await fetchPreview(file, 0);

            // 3. Start fetching thumbnails (Non-blocking)
            fetchThumbnails(file, count);
    ...
    // --- EDITOR UI (When preview is loaded) ---
                            ...
                            <div className="flex-1 overflow-auto p-8 flex items-center justify-center bg-zinc-100/50 dark:bg-black/20">
                                {isLoadingPreview ? (
                                    <div className="text-center">
                                        ...
                                        <p className="mt-4 text-zinc-600 dark:text-zinc-400">Loading preview...</p>
                                    </div>
                                ) : (
        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-black transition-colors duration-300 font-sans">
            ...
            <div className="mx-auto max-w-5xl px-6 py-12 lg:px-8 pt-32">
                ...
                >
                    ...
                    >
                        Trim margins and crop pages in your PDF.
                    </motion.p>
                </motion.div>
