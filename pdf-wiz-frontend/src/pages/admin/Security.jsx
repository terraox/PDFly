      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`flex items-center gap-2 h-10 rounded-md px-4 text-sm font-medium transition-colors ${maintenance ? 'bg-red-500/10 text-red-400 border border-red-500/50' : 'bg-zinc-800 text-zinc-300 border border-zinc-700'
              }`}
          >
